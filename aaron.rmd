...
```{r}
Master_v1 <- Master %>% select(-c(`All Addresses balance`, `Addresses balance greater than $100`, `AddressCount100K`, `Addresses balance greater than $10`, `AddressCount10M`, `Addresses balance greater than $1`, `TotalBlockWeight`, `Capitalization of active native units supply, in USD`, `MarketCapitalizationSupply`, `Capitalization of free float, in USD`, `Capitalization realized, USD`, `TransactionFee`, `BlockGas`, `NVT, adjusted, free float`, `Miner Rev ($)`, `Supply`, `Supply, current`, `Flow transfers exchanges`, `Supply, address balance (<1in100M)`, `Supply, in addresses (<$1M)`, `Transactions, transfer count`, `NUPL`, `rHODL`, ))
```


```{r}
Master_v1 <- Master %>% mutate(Date = ymd(Date)) %>% 
