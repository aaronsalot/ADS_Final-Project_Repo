...
```{r}
Master.v9 <- Master.v9 %>% select(-c(`Addresses Active Count`, `Addresses balance greater than $100K`, `Addresses balance greater than $10K`, `Addresses balance greater than $1K`, `Block, weight, total`, `Addresses balance greater than $1M`))
```
